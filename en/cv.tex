...
\newline
Familiar: \textsc{JAVA}, C\#, Matlab, Ruby, JavaScript, Akka, Scala, Haskell and Prolog.
}
...
\cvitem{Technologies}{%
  Familiar: Django, Android, Ansible, Docker, Yocto, LAVA, AWS, Blender, Unity, OpenLDAP, BIND (DNS), NFS, Postfix, CUPS, NTP, NFS, PostgreSQL, Oracle and MySQL.
}
